...
trait(cerdocyon_thous,litter_clutch_size_cat,medium).
...
trait(kerodon_rupestris,habitat_breadth_cat,low).
...
trait(peromyscus_maniculatus,diet_breadth_cat,medium).
...
trait(peromyscus_truei,diet_breadth_cat,medium).
...
trait(philander_frenatus,habitat_breadth_cat,low).
...
trait(rattus_norvegicus,diet_breadth_cat,medium).
...
trait(rattus_rattus,diet_breadth_cat,medium).
...
% Examples start here
#pos({roadkill_risk(alouatta_caraya,low)},{roadkill_risk(alouatta_caraya,medium),roadkill_risk(alouatta_caraya,high)}).
#pos({roadkill_risk(alouatta_palliata,medium)},{roadkill_risk(alouatta_palliata,low),roadkill_risk(alouatta_palliata,high)}).
#pos({roadkill_risk(alouatta_seniculus,medium)},{roadkill_risk(alouatta_seniculus,low),roadkill_risk(alouatta_seniculus,high)}).
#pos({roadkill_risk(bassariscus_astutus,low)},{roadkill_risk(bassariscus_astutus,medium),roadkill_risk(bassariscus_astutus,high)}).
#pos({roadkill_risk(bradypus_tridactylus,low)},{roadkill_risk(bradypus_tridactylus,medium),roadkill_risk(bradypus_tridactylus,high)}).
#pos({roadkill_risk(bradypus_variegatus,medium)},{roadkill_risk(bradypus_variegatus,low),roadkill_risk(bradypus_variegatus,high)}).
#pos({roadkill_risk(callithrix_geoffroyi,medium)},{roadkill_risk(callithrix_geoffroyi,low),roadkill_risk(callithrix_geoffroyi,high)}).
#pos({roadkill_risk(callithrix_jacchus,medium)},{roadkill_risk(callithrix_jacchus,low),roadkill_risk(callithrix_jacchus,high)}).
#pos({roadkill_risk(callithrix_penicillata,low)},{roadkill_risk(callithrix_penicillata,medium),roadkill_risk(callithrix_penicillata,high)}).
#pos({roadkill_risk(caluromys_philander,medium)},{roadkill_risk(caluromys_philander,low),roadkill_risk(caluromys_philander,high)}).
#pos({roadkill_risk(canis_latrans,low)},{roadkill_risk(canis_latrans,medium),roadkill_risk(canis_latrans,high)}).
#pos({roadkill_risk(cavia_aperea,high)},{roadkill_risk(cavia_aperea,low),roadkill_risk(cavia_aperea,medium)}).
#pos({roadkill_risk(cerdocyon_thous,high)},{roadkill_risk(cerdocyon_thous,low),roadkill_risk(cerdocyon_thous,medium)}).
#pos({roadkill_risk(choloepus_didactylus,medium)},{roadkill_risk(choloepus_didactylus,low),roadkill_risk(choloepus_didactylus,high)}).
#pos({roadkill_risk(chrysocyon_brachyurus,low)},{roadkill_risk(chrysocyon_brachyurus,medium),roadkill_risk(chrysocyon_brachyurus,high)}).
#pos({roadkill_risk(coendou_prehensilis,medium)},{roadkill_risk(coendou_prehensilis,low),roadkill_risk(coendou_prehensilis,high)}).
#pos({roadkill_risk(cuniculus_paca,low)},{roadkill_risk(cuniculus_paca,medium),roadkill_risk(cuniculus_paca,high)}).
#pos({roadkill_risk(dasypus_novemcinctus,high)},{roadkill_risk(dasypus_novemcinctus,low),roadkill_risk(dasypus_novemcinctus,medium)}).
#pos({roadkill_risk(didelphis_albiventris,high)},{roadkill_risk(didelphis_albiventris,low),roadkill_risk(didelphis_albiventris,medium)}).
#pos({roadkill_risk(didelphis_aurita,high)},{roadkill_risk(didelphis_aurita,low),roadkill_risk(didelphis_aurita,medium)}).
#pos({roadkill_risk(didelphis_marsupialis,high)},{roadkill_risk(didelphis_marsupialis,low),roadkill_risk(didelphis_marsupialis,medium)}).
#pos({roadkill_risk(didelphis_virginiana,high)},{roadkill_risk(didelphis_virginiana,low),roadkill_risk(didelphis_virginiana,medium)}).
#pos({roadkill_risk(dolichotis_patagonum,high)},{roadkill_risk(dolichotis_patagonum,low),roadkill_risk(dolichotis_patagonum,medium)}).
#pos({roadkill_risk(eira_barbara,low)},{roadkill_risk(eira_barbara,medium),roadkill_risk(eira_barbara,high)}).
#pos({roadkill_risk(herpailurus_yagouaroundi,low)},{roadkill_risk(herpailurus_yagouaroundi,medium),roadkill_risk(herpailurus_yagouaroundi,high)}).
#pos({roadkill_risk(hydrochoerus_hydrochaeris,medium)},{roadkill_risk(hydrochoerus_hydrochaeris,low),roadkill_risk(hydrochoerus_hydrochaeris,high)}).
#pos({roadkill_risk(kerodon_rupestris,medium)},{roadkill_risk(kerodon_rupestris,low),roadkill_risk(kerodon_rupestris,high)}).
#pos({roadkill_risk(lama_guanicoe,high)},{roadkill_risk(lama_guanicoe,low),roadkill_risk(lama_guanicoe,medium)}).
#pos({roadkill_risk(leopardus_geoffroyi,high)},{roadkill_risk(leopardus_geoffroyi,low),roadkill_risk(leopardus_geoffroyi,medium)}).
#pos({roadkill_risk(leopardus_pardalis,low)},{roadkill_risk(leopardus_pardalis,medium),roadkill_risk(leopardus_pardalis,high)}).
#pos({roadkill_risk(leopardus_tigrinus,medium)},{roadkill_risk(leopardus_tigrinus,low),roadkill_risk(leopardus_tigrinus,high)}).
#pos({roadkill_risk(lepus_europaeus,medium)},{roadkill_risk(lepus_europaeus,low),roadkill_risk(lepus_europaeus,high)}).
#pos({roadkill_risk(lutreolina_crassicaudata,medium)},{roadkill_risk(lutreolina_crassicaudata,low),roadkill_risk(lutreolina_crassicaudata,high)}).
#pos({roadkill_risk(lycalopex_culpaeus,high)},{roadkill_risk(lycalopex_culpaeus,low),roadkill_risk(lycalopex_culpaeus,medium)}).
#pos({roadkill_risk(lycalopex_gymnocercus,high)},{roadkill_risk(lycalopex_gymnocercus,low),roadkill_risk(lycalopex_gymnocercus,medium)}).
#pos({roadkill_risk(lycalopex_vetulus,medium)},{roadkill_risk(lycalopex_vetulus,low),roadkill_risk(lycalopex_vetulus,high)}).
#pos({roadkill_risk(mazama_americana,medium)},{roadkill_risk(mazama_americana,low),roadkill_risk(mazama_americana,high)}).
#pos({roadkill_risk(mazama_gouazoubira,medium)},{roadkill_risk(mazama_gouazoubira,low),roadkill_risk(mazama_gouazoubira,high)}).
#pos({roadkill_risk(mico_melanurus,low)},{roadkill_risk(mico_melanurus,medium),roadkill_risk(mico_melanurus,high)}).
#pos({roadkill_risk(mus_musculus,high)},{roadkill_risk(mus_musculus,low),roadkill_risk(mus_musculus,medium)}).
#pos({roadkill_risk(mustela_frenata,high)},{roadkill_risk(mustela_frenata,low),roadkill_risk(mustela_frenata,medium)}).
#pos({roadkill_risk(myocastor_coypus,medium)},{roadkill_risk(myocastor_coypus,low),roadkill_risk(myocastor_coypus,high)}).
#pos({roadkill_risk(myrmecophaga_tridactyla,high)},{roadkill_risk(myrmecophaga_tridactyla,low),roadkill_risk(myrmecophaga_tridactyla,medium)}).
#pos({roadkill_risk(nasua_narica,medium)},{roadkill_risk(nasua_narica,low),roadkill_risk(nasua_narica,high)}).
#pos({roadkill_risk(nasua_nasua,medium)},{roadkill_risk(nasua_nasua,low),roadkill_risk(nasua_nasua,high)}).
#pos({roadkill_risk(otospermophilus_variegatus,medium)},{roadkill_risk(otospermophilus_variegatus,low),roadkill_risk(otospermophilus_variegatus,high)}).
#pos({roadkill_risk(ozotoceros_bezoarticus,low)},{roadkill_risk(ozotoceros_bezoarticus,medium),roadkill_risk(ozotoceros_bezoarticus,high)}).
#pos({roadkill_risk(panthera_onca,low)},{roadkill_risk(panthera_onca,medium),roadkill_risk(panthera_onca,high)}).
#pos({roadkill_risk(pecari_tajacu,low)},{roadkill_risk(pecari_tajacu,medium),roadkill_risk(pecari_tajacu,high)}).
#pos({roadkill_risk(peromyscus_maniculatus,high)},{roadkill_risk(peromyscus_maniculatus,low),roadkill_risk(peromyscus_maniculatus,medium)}).
#pos({roadkill_risk(peromyscus_truei,low)},{roadkill_risk(peromyscus_truei,medium),roadkill_risk(peromyscus_truei,high)}).
#pos({roadkill_risk(philander_frenatus,low)},{roadkill_risk(philander_frenatus,medium),roadkill_risk(philander_frenatus,high)}).
#pos({roadkill_risk(philander_opossum,high)},{roadkill_risk(philander_opossum,low),roadkill_risk(philander_opossum,medium)}).
#pos({roadkill_risk(potos_flavus,low)},{roadkill_risk(potos_flavus,medium),roadkill_risk(potos_flavus,high)}).
#pos({roadkill_risk(procyon_cancrivorus,high)},{roadkill_risk(procyon_cancrivorus,low),roadkill_risk(procyon_cancrivorus,medium)}).
#pos({roadkill_risk(procyon_lotor,medium)},{roadkill_risk(procyon_lotor,low),roadkill_risk(procyon_lotor,high)}).
#pos({roadkill_risk(puma_concolor,low)},{roadkill_risk(puma_concolor,medium),roadkill_risk(puma_concolor,high)}).
#pos({roadkill_risk(rattus_norvegicus,low)},{roadkill_risk(rattus_norvegicus,medium),roadkill_risk(rattus_norvegicus,high)}).
#pos({roadkill_risk(rattus_rattus,high)},{roadkill_risk(rattus_rattus,low),roadkill_risk(rattus_rattus,medium)}).
#pos({roadkill_risk(reithrodontomys_megalotis,low)},{roadkill_risk(reithrodontomys_megalotis,medium),roadkill_risk(reithrodontomys_megalotis,high)}).
#pos({roadkill_risk(saguinus_midas,low)},{roadkill_risk(saguinus_midas,medium),roadkill_risk(saguinus_midas,high)}).
#pos({roadkill_risk(saimiri_sciureus,medium)},{roadkill_risk(saimiri_sciureus,low),roadkill_risk(saimiri_sciureus,high)}).
#pos({roadkill_risk(sapajus_apella,low)},{roadkill_risk(sapajus_apella,medium),roadkill_risk(sapajus_apella,high)}).
#pos({roadkill_risk(sapajus_cay,medium)},{roadkill_risk(sapajus_cay,low),roadkill_risk(sapajus_cay,high)}).
#pos({roadkill_risk(sapajus_libidinosus,low)},{roadkill_risk(sapajus_libidinosus,medium),roadkill_risk(sapajus_libidinosus,high)}).
#pos({roadkill_risk(sigmodon_hispidus,high)},{roadkill_risk(sigmodon_hispidus,low),roadkill_risk(sigmodon_hispidus,medium)}).
#pos({roadkill_risk(speothos_venaticus,low)},{roadkill_risk(speothos_venaticus,medium),roadkill_risk(speothos_venaticus,high)}).
#pos({roadkill_risk(sylvilagus_audubonii,high)},{roadkill_risk(sylvilagus_audubonii,low),roadkill_risk(sylvilagus_audubonii,medium)}).
#pos({roadkill_risk(sylvilagus_floridanus,high)},{roadkill_risk(sylvilagus_floridanus,low),roadkill_risk(sylvilagus_floridanus,medium)}).
