...
% Examples start here
#pos({roadkill_risk(alouatta_caraya,low)},{}).
#pos({roadkill_risk(alouatta_palliata,medium)},{}).
#pos({roadkill_risk(alouatta_seniculus,medium)},{}).
#pos({roadkill_risk(bassariscus_astutus,low)},{}).
#pos({roadkill_risk(bradypus_tridactylus,low)},{}).
#pos({roadkill_risk(bradypus_variegatus,medium)},{}).
#pos({roadkill_risk(callithrix_geoffroyi,medium)},{}).
#pos({roadkill_risk(callithrix_jacchus,medium)},{}).
#pos({roadkill_risk(callithrix_penicillata,low)},{}).
#pos({roadkill_risk(caluromys_philander,medium)},{}).
#pos({roadkill_risk(canis_latrans,low)},{}).
#pos({roadkill_risk(cavia_aperea,high)},{}).
#pos({roadkill_risk(cerdocyon_thous,high)},{}).
#pos({roadkill_risk(choloepus_didactylus,medium)},{}).
#pos({roadkill_risk(chrysocyon_brachyurus,low)},{}).
#pos({roadkill_risk(coendou_prehensilis,medium)},{}).
...
#pos({roadkill_risk(eira_barbara,low)},{}).
#pos({roadkill_risk(herpailurus_yagouaroundi,low)},{}).
#pos({roadkill_risk(hydrochoerus_hydrochaeris,medium)},{}).
#pos({roadkill_risk(kerodon_rupestris,medium)},{}).
#pos({roadkill_risk(lama_guanicoe,high)},{}).
#pos({roadkill_risk(leopardus_geoffroyi,high)},{}).
#pos({roadkill_risk(leopardus_pardalis,low)},{}).
#pos({roadkill_risk(leopardus_tigrinus,medium)},{}).
#pos({roadkill_risk(lepus_europaeus,medium)},{}).
#pos({roadkill_risk(lutreolina_crassicaudata,medium)},{}).
#pos({roadkill_risk(lycalopex_culpaeus,high)},{}).
#pos({roadkill_risk(lycalopex_gymnocercus,high)},{}).
#pos({roadkill_risk(lycalopex_vetulus,medium)},{}).
#pos({roadkill_risk(mazama_americana,medium)},{}).
#pos({roadkill_risk(mazama_gouazoubira,medium)},{}).
#pos({roadkill_risk(mico_melanurus,low)},{}).
...
#pos({roadkill_risk(nasua_narica,medium)},{}).
#pos({roadkill_risk(nasua_nasua,medium)},{}).
#pos({roadkill_risk(otospermophilus_variegatus,medium)},{}).
#pos({roadkill_risk(ozotoceros_bezoarticus,low)},{}).
#pos({roadkill_risk(panthera_onca,low)},{}).
#pos({roadkill_risk(pecari_tajacu,low)},{}).
#pos({roadkill_risk(peromyscus_maniculatus,high)},{}).
#pos({roadkill_risk(peromyscus_truei,low)},{}).
#pos({roadkill_risk(philander_frenatus,low)},{}).
#pos({roadkill_risk(philander_opossum,high)},{}).
#pos({roadkill_risk(potos_flavus,low)},{}).
#pos({roadkill_risk(procyon_cancrivorus,high)},{}).
#pos({roadkill_risk(procyon_lotor,medium)},{}).
#pos({roadkill_risk(puma_concolor,low)},{}).
#pos({roadkill_risk(rattus_norvegicus,low)},{}).
#pos({roadkill_risk(rattus_rattus,high)},{}).
#pos({roadkill_risk(reithrodontomys_megalotis,low)},{}).
#pos({roadkill_risk(saguinus_midas,low)},{}).
#pos({roadkill_risk(saimiri_sciureus,medium)},{}).
#pos({roadkill_risk(sapajus_apella,low)},{}).
#pos({roadkill_risk(sapajus_cay,medium)},{}).
#pos({roadkill_risk(sapajus_libidinosus,low)},{}).
#pos({roadkill_risk(sigmodon_hispidus,high)},{}).
#pos({roadkill_risk(speothos_venaticus,low)},{}).
